...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		while(true)
		{
			...
			System.out.printf("\n");
			System.out.printf("player : [%s %02d]",player.get(0).GetSuit(), player.get(0).GetNumber());
			for(int i = 1;i<dealer.size();i++)
			{
				System.out.printf(", [%s %02d]", player.get(i).GetSuit(), player.get(i).GetNumber());
			}
			System.out.printf("\n");
			System.out.println("------------------");
		}
		...
		System.out.println("------------------");
		System.out.printf("dealer : [%s %02d]",dealer.get(0).GetSuit(), dealer.get(0).GetNumber());
		for(int i = 1;i<dealer.size();i++)
		{
			System.out.printf(", [%s %02d]", dealer.get(i).GetSuit(), dealer.get(i).GetNumber());
		}
